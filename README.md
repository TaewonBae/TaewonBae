...
<br>
### Project
#### [날마다자라는아이(Android) : 신체측정기능 및 아이들의 및 성장과정을 한눈에 볼 수 있는 프로그램/Android Studio(Java)/DataBase/OpenCV/Detection](https://github.com/TaewonBae/Android-UI-UX-Study) - (주)날마다자라는아이 Android App Project
